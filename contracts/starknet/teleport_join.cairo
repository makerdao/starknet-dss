...
namespace FeesLike {
    func getFee(
        calldata: TeleportGUID, line: Uint256, debt: Int256, pending: Uint256, amtToTake: Uint256
    ) -> (fees: Uint256) {
    }
}
...
func _mint{
    ...
    teleportGUID: TeleportGUID, hashGUID: felt, max_fee_percentage: Uint256, operator_fee: Uint256
