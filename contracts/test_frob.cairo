...
func test_setup{
    ...
    # let (res) = gem('gold', contract_address) # TODO FIX
...
func test_join{
    ...
    IGemJoin.join(gemA, urn,       Uint256(1000*ether, 0))
    let (thisBalance) = IMockToken.balanceOf(gold, urn)
    assertEqUint256(thisBalance,     Uint256(50*ether, 0))
    let (gemABalance) = IMockToken.balanceOf(gold, gemA)
...
func test_calm{
    ...
    # let (res) = try_frob('gold', Uint256(10*ether, 0), Uint256(9*ether, 0)) # TODO FIX
    # assertTrue(res)
